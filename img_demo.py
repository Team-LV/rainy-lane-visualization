...
if __name__ == "__main__":
    ...
    output_image_path = "./img_test_output.jpg"  # Specify the path where you want to save the image
    cv2.imwrite(output_image_path, im0)

    # Close the OpenCV window (if displayed)
